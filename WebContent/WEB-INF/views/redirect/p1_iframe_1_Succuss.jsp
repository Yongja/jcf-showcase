...
<html>
	<head>
		...
		<script src="/jcf-showcase/js/p1.js"></script>
	</head>
	<body>
		<div id="p11_5_result" class="bs-docs-example-result">
   			<p> ${DS_OUT} </p>
		</div>
		<br/>
		<a href="/jcf-showcase/openpage.do?viewname=p1_iframe_1" class="btn btn-link">이전 페이지로</a>
	</body>
</html>