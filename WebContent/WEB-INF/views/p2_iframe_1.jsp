...
<html>
	...
	<body>
		<form id="p21_1_Form" class="form-horizontal" method="post"
			action="/jcf-showcase/sample/file/sampleFileUploadWithInfo.do" enctype="multipart/form-data" >
			<div class="control-group">
				<label class="control-label" for="p21_1_param1">내용 : </label>
				<div class="controls">
					<input type="text" name="content" id="p21_1_param1" />
				</div>
			</div>
			<div class="control-group">
				<label class="control-label" for="p21_1_param3">파일 : </label>
				<div class="controls">
					<input type="file" name="param" id="p21_1_param2" /> <br />
					<br />
					<button class="btn" type="submit" id="p21_1_btn1">전송</button>
				</div>
			</div>
		</form>
	</body>
